...
class ConsentTests(unittest.TestCase):
    ...
    def test_only_explicit_current_consent_enables_protection(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertTrue(guard.protection_enabled(settings))

    def test_disabled_startup_is_portable_and_does_not_create_runtime_state(self):
